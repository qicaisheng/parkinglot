...
public class ParkingLotTest {
    ...
    @Test
    public void should_be_able_to_pick_up_when_the_card_park_into_parking_lot() throws ParkingLotFullException {
        Car car = new Car();
    ...
    @Test
    public void should_not_be_able_to_pick_up_again_when_the_card_pick_up_from_parking_lot() throws ParkingLotFullException {
        Car car = new Car();
        ParkingLot parkingLot = new ParkingLot(1);
        parkingLot.park(car);
